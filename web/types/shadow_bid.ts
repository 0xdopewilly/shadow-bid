...
export type ShadowBid = {
  "address": "EvyVpkAWdKABJAZZ73YkMwGiVS3QJMEJ7vHvKh6FYuBt",
  "metadata": {
    "name": "shadowBid",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Shadow Bid — confidential sealed-bid auction (Arcium MXE)"
  },
  "instructions": [
    {
      "name": "createAuction",
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            ...
            "type": {
              "defined": {
                "name": "revealWinnerOutputStruct01"
              }
            }
          }
        ]
